...
public class ManageItemsFormController {
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
            if (!existItem(code)) {
                new Alert(Alert.AlertType.ERROR, "There is no such customer associated with the id " + code).show();
            }
    ...
    private boolean existItem(String code) throws SQLException, ClassNotFoundException {
        ...
        boolean isExist =itemDaoImpl.existItem(code);
        return isExist;
    }
    ...
    private String generateNewId() {
            ...
            try{
                ...
                code= itemDaoImpl.generateNewItemCode(code);
